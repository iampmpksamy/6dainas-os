...
import (
	...
	http2 "github.com/6dainas/6dainas-os-Common/utils/http"
	"github.com/6dainas/6dainas-os-Common/utils/port"
	"github.com/6dainas/6dainas-os/common"
	"github.com/6dainas/6dainas-os/model"
	"github.com/6dainas/6dainas-os/pkg/config"
	"github.com/6dainas/6dainas-os/pkg/utils"
	"github.com/6dainas/6dainas-os/pkg/utils/common_err"
	"github.com/6dainas/6dainas-os/pkg/utils/version"
	"github.com/6dainas/6dainas-os/service"
	model2 "github.com/6dainas/6dainas-os/service/model"
	"github.com/6dainas/6dainas-os/types"
...
func GetSystemCheckVersion(ctx echo.Context) error {
	...
	if need {
		...
		installLog.Name = "6DAiNAS-OS System"
