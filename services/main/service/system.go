...
import (
	...
	exec2 "github.com/6dainas/6dainas-os-Common/utils/exec"
	...
	"github.com/6dainas/6dainas-os/pkg/utils/httper"
	"github.com/6dainas/6dainas-os/pkg/utils/ip_helper"
...
func (c *systemService) GenreateSystemEntry() {
	modelsPath := "/var/lib/6dainas/www/modules"
