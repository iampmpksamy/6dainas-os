...
import (
	...
	interfaces "github.com/6dainas/6dainas-os-Common"
	"github.com/6dainas/6dainas-os-Common/utils/systemctl"
	"github.com/6dainas/6dainas-user-service/common"
)

const (
	userServiceConfigDirPath  = "/etc/6dainas"
	userServiceConfigFilePath = "/etc/6dainas/user-service.conf"
	userServiceName           = "6dainas-user-service.service"
	userServiceNameShort      = "user-service"
)

//go:embedded ../../build/sysroot/etc/6dainas/user-service.conf.sample
