...
import (
	...
	"github.com/6dainas/6dainas-os-Common/utils/jwt"
	"github.com/6dainas/6dainas-os-Common/utils/logger"
	"github.com/6dainas/6dainas-user-service/codegen/message_bus"
	"github.com/6dainas/6dainas-user-service/common"
	"github.com/6dainas/6dainas-user-service/pkg/config"
	"github.com/6dainas/6dainas-user-service/pkg/sqlite"
	"github.com/6dainas/6dainas-user-service/pkg/utils/encryption"
	"github.com/6dainas/6dainas-user-service/pkg/utils/random"
	"github.com/6dainas/6dainas-user-service/route"
...
var (
	...
	//go:embed build/sysroot/etc/6dainas/user-service.conf.sample
	_confSample string
)
