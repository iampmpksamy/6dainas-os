...
const (
	messageBusConfigDirPath  = "/etc/6dainas"
	messageBusConfigFilePath = "/etc/6dainas/message-bus.conf"
	messageBusName           = "6dainas-message-bus.service"
	messageBusNameShort      = "message-bus"
)

//go:embedded ../../build/sysroot/etc/6dainas/message-bus.conf.sample
