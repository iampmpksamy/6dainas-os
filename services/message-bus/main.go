...
import (
	...
	"github.com/6dainas/6dainas-message-bus/common"
	"github.com/6dainas/6dainas-message-bus/config"
	"github.com/6dainas/6dainas-message-bus/repository"
	"github.com/6dainas/6dainas-message-bus/route"
...
var (
	...
	//go:embed build/sysroot/etc/6dainas/message-bus.conf.sample
	_confSample string
