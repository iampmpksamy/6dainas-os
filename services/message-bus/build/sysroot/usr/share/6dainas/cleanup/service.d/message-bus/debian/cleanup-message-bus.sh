...
readonly CASA_SERVICES=(
    "6dainas-message-bus.service"
)

readonly CASA_EXEC=6dainas-message-bus
readonly CASA_CONF=/etc/6dainas/message-bus.conf
readonly CASA_DB=/var/lib/6dainas/db/message-bus.db
