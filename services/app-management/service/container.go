...
import (
	...
	"github.com/6dainas/6dainas-app-management/pkg/utils/envHelper"
	...
	timeutils "github.com/6dainas/6dainas-os-Common/utils/time"
...
func (ds *dockerService) CreateContainer(m model.CustomizationPostData, id string) (containerID string, err error) {
	...
	if err == nil {
		...
		config = info.Config
		if config.Labels["6dainas"] == "6dainas" {
			config.Cmd = m.Cmd
