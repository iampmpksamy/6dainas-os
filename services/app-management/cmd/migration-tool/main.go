...
const (
	appManagementConfigDirPath  = "/etc/6dainas"
	appManagementConfigFilePath = "/etc/6dainas/app-management.conf"
	appManagementName           = "6dainas-app-management.service"
	appManagementNameShort      = "app-management"
)

//go:embedded ../../build/sysroot/etc/6dainas/app-management.conf.sample
