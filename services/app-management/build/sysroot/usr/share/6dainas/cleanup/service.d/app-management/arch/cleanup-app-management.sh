...
readonly CASA_SERVICES=(
    "6dainas-app-management.service"
)

readonly CASA_EXEC=6dainas-app-management
readonly CASA_CONF=/etc/6dainas/app-management.conf
readonly CASA_DB=/var/lib/6dainas/db/app-management.db
